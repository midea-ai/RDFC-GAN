...
class NYUV21400Dataset(BaseDataset):
    ...
    def get_train_data(self, idx):
        ...
        #cut off the black border in raw nyuv2 official data
        ...
        t_labels = T.Compose([T.Resize(self.height,interpolation=0),
                              T.CenterCrop(self.crop_size),
                            self.ToNumpy()])
