...
# import warnings
from lib.models.module.conv_norm_act import ConvModule
...
class PatchGANDiscriminator(nn.Module):
    ...
    def __init__(self,
                 ...
                 # norm_cfg=dict(type='BN2d', in_discriminator=True),
                 norm_cfg=dict(type='BN2d'),           # TODO: need to check if there are still bugs
                 activation='ReLU'):
