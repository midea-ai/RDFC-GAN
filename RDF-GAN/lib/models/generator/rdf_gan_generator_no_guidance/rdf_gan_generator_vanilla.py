...
from ..rdf_gan_generator.model_utils import DCVGANDecoderModule, ConvNormAct
    ...
    def init_weight(self):
        ...
        for name, c in self.named_children():
            if name == 'global_guidance_module':
                ...
                for m in c.children():
                    if isinstance(m, ESANetOneModality):
                        continue
                    for mm in m.modules():
